 ...
 * @author çpc
 */
class consulterUsineHandler implements HttpHandler {

           public void handle(HttpExchange t) {
           
        String reponse = "Voici la liste des usines et ses voitures dans les parkings";
        JSONObject objet = recuperarUsines(); 
        ...
        try {
          ...
          private JSONObject recuperarUsines() throws JSONException {
        //Recuperation des utilisateurs de fichier user.json
        
        // Récupération de la chaîne JSON depuis le fichier
        String json = "";
        try {
            byte[] contenu = Files.readAllBytes(Paths.get("usine.json"));
